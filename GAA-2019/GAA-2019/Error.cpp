...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(108, "Ëåêñåìà íå ğàñïîçíàíà"), ERROR_ENTRY(109, "Ïğåâûøåí ğàçìåğ ëèòåğàëà"),
		...
		ERROR_ENTRY_NODEF(315),ERROR_ENTRY_NODEF(316),ERROR_ENTRY_NODEF(317),ERROR_ENTRY_NODEF(318),ERROR_ENTRY_NODEF(319),
